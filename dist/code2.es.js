...
` + l + s.substring(u === -1 ? s.length : u);
  ...
  watch: {
    ...
    convertedHtml(e) {
      this.convertedMd = this.$turndown.turndown(
        typeof e == "string" ? e : ""
      );
    }
